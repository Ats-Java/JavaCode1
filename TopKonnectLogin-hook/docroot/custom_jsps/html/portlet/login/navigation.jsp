	...
	<div class="navigation" style="background-color:white; ">
		<liferay-ui:icon-list>
			...
			<c:if test="<%= showFacebookConnectIcon %>">
				...
				%>
				<%-- <a herf="<%= taglibOpenFacebookConnectLoginWindow %>" id="myid" style="text-decoration: none;z-index: -99999;position: relative;top:-40%;left: 60%;"><img src="/html/portlet/login/fb.png"/></a>
				 --%>

					<span id="mytext" style="font-size: 20px;color:black;font-weight: bold;left: 68%; position: relative; top: -450px; width: 17.8%; z-index: 99999;color:#00708c"></span>
					<a href="<%= taglibOpenFacebookConnectLoginWindow %>"
						style="text-decoration: none;"><img
						src="/html/portlet/login/fb2.jpg" id="fb"
						style="left: 55%; position: relative; top: -323px; width: 17.8%; z-index: 99999;" /></a>
					<a href="<%= taglibOpenGoogleLoginWindow %>" style="text-decoration: none;"><img id="google"
						src="/html/portlet/login/go4.png"
						style="height: 42.3px; left: 37.0%; position: relative; top: -261px; width: 17.6%; z-index: 99999;" /></a>	
					<!-- <a href="#" style="text-decoration: none;"><img id="ln"
						src="/html/portlet/login/ln2.jpg"
						style="left: 37%; position: relative; top: -261px; width: 17.8%; z-index: 99999;" /></a> -->
					<%-- <a href="<%= taglibOpenGoogleLoginWindow %>" style="text-decoration: none;"><img id="google"
						src="/html/portlet/login/go4.png"
						style="height: 42.3px; left: 19.0%; position: relative; top: -199.3px; width: 17.6%; z-index: 99999;" /></a> --%>
